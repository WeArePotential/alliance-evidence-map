  ...
  <div id="sidebar" :style="{width: width + 'px'}">
    <div class="section header">
      ...
      <div class="description">
        <p>The <a href="http://www.aidsalliance.org/">International HIV/AIDS Alliance</a> works with communities in over 40 countries to take local, national and global action on HIV, health and human rights.</p>
        <div v-if="showInfoText">
          <p>Producing, using and applying the best available research is a critical element of the Alliance’s commitment to being an outcomes-driven and evidence-based organisation and is essential for us to deliver our programmes and influence policy effectively.</p>
          ...
          <p>For more information on how the map was created and how to use it, read the <a href="docs/User Guide.pdf">User Guide</a>. If you have questions please email: <a href="mailto:evidencemap@aidsalliance.org">evidencemap@aidsalliance.org</a></p>
        </div>
      </div>
      <div class="info-text-button" v-on:click="toggleInfoText"><span v-if="showInfoText">Hide</span><span v-else>More...</span></div>
    </div>
